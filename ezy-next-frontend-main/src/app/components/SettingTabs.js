...
const tabs = [
  { name: "GENERAL SETTINGS", link: "./SettingPage1" },
  { name: "CUSTOM DASHBOARD", link: "./SettingPage2" },
  { name: "SIDEBAR SETTINGS", link: "./SettingPage3" },
  { name: "THEME SETTINGS", link: "./SettingPage4" }
];
