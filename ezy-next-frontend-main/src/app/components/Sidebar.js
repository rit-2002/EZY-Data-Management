...
const sidebarItems = [
  {
    ...
    submenuComponent: [
      ...
      // { text: "AI Generated", link: "/ai_generated", tab: "/" },
    ],
  },
  {
    icon: <FaCheckCircle />,
    text: "Data Integration",
    link: "/DataIntegration",
  ...
  },
  {
    ...
    submenuComponent: [
      ...
      {
        text: "Integration Setting",
        link: "/setting",
        tab: "integration-setting",
      },
      { text: "Notification", link: "/setting", tab: "notification" },
