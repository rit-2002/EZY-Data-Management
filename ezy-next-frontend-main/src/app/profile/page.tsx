...
const Profile: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const isValid = Object.keys(formData).every((key) =>
            validateInput(key, formData[key as keyof FormData])
        );
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                notifyError(
                    response.data?.message || "Failed to update profile. Unknown error."
                );
            }
        } catch (error: any) {
            const errorMessage =
    ...
    return (
        <ProtectedRoute>
            <ResponsiveContainer>
                ...
                >
                    <div className="max-w-7/12 mx-auto p-8 md:p-10 lg:p-12 mt-20 bg-white rounded-lg shadow-lg dark:bg-gray-800">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-3">
                            ...
                            <div className="mt-10 p-2">
                                <button
                                    ...
                                    className="w-full active:scale-95 active:bg-opacity-90 transition-all duration-300 py-2 px-3 bg-indigo-600 text-sm font-medium text-white rounded-md"
                                >
                                    Submit
                                </button>
                            </div>
